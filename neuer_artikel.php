...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Artikel (Artikelname, Einkaufspreis_org, Einkaufspreis, EmpfohlenerVerkaufspreis)
            VALUES ('$artikelname', '$einkaufspreis_org', '$einkaufspreis', '$empfohlener_verkaufspreis')";
...
<form action="neuer_artikel.php" method="POST">
    ...
    <input type="number" step="0.01" name="einkaufspreis_org" id="einkaufspreis_org">
