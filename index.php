...
<body>
    ...
    <ul>
        ...
        <main>
            <h2>Herzlich Willkommen im PawnShop-OS</h2>
            <p>Dies ist ein erster Versuch von jemandem der nur überschaubare Erfahrungen mit der Programmierung hat.</p>
            <p>Bei Fragen könnt ihr euch an <a href="mailto:bjoern.flessing@flexible-domains.de">bjoern.flessing@flexible-domains.de</a> wenden.</p>

            <?php if (isset($_SESSION['benutzer_id'])): ?>
                <p>Willkommen, <?php echo $benutzer_rolle; ?>!</p>
                <a href="logout.php">Logout</a>
            <?php endif; ?>
        </main>
    </div>

    <!-- Der Rest Ihrer HTML-Seite hier -->
</body>
</html>
